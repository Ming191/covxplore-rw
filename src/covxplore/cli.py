...
def run_generation() -> None:
    ...
    max_iterations = (
        args.max_iter if args.max_iter is not None else cfg.max_iterations
    )
    mcdc_target = (
        args.mcdc_target if args.mcdc_target is not None else cfg.mcdc_target
    )
    ...
    result = AblationRunner().run_one(exp_cfg)
...
def run_ablation() -> None:
    ...
    variants = _resolve_variants(args, parser)
...
def _resolve_variants(
    ...
    return get_leave_one_out_variants() if args.leave_one_out else args.variants
